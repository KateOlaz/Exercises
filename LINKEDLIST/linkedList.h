...
class linkedListType
{
    ...
    private:
        ...
        //Esto se debe a que esta función se usa solo para implementar el constructor de copia y sobrecargar el operador de asignación.
...
void linkedListType<Type>::destroyList()
{
    ...
    last = NULL; 
    //initialize last to NULL; first has already
